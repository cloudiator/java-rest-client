    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          ...
          .registerTypeSelector(Requirement.class, new TypeSelector() {
            ...
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("AttributeRequirement".toUpperCase(), AttributeRequirement.class);
                classByDiscriminatorValue.put("IdentifierRequirement".toUpperCase(), IdentifierRequirement.class);
                classByDiscriminatorValue.put("OclRequirement".toUpperCase(), OclRequirement.class);
                classByDiscriminatorValue.put("Requirement".toUpperCase(), Requirement.class);
                return getClassByDiscriminator(
                                           classByDiscriminatorValue,
                                           getDiscriminatorValue(readElement, "type"));
            }
