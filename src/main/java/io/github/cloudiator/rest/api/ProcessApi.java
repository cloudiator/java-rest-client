...
public class ProcessApi {
    ...
    public Queue deleteSchedule(String id) throws ApiException {
        ApiResponse<Queue> resp = deleteScheduleWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteScheduleAsync(String id, final ApiCallback<Queue> callback) throws ApiException {
    ...
    /**
     * Build call for findProcessGroups
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call findProcessGroupsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/processGroup";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call findProcessGroupsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = findProcessGroupsCall(progressListener, progressRequestListener);
        return call;
     ...
     * @return List&lt;ProcessGroup&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ProcessGroup> findProcessGroups() throws ApiException {
        ApiResponse<List<ProcessGroup>> resp = findProcessGroupsWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * Returns all process groups for the current user
     * @return ApiResponse&lt;List&lt;ProcessGroup&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ProcessGroup>> findProcessGroupsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = findProcessGroupsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<ProcessGroup>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findProcessGroupsAsync(final ApiCallback<List<ProcessGroup>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = findProcessGroupsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ProcessGroup>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call scheduleGraphCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call scheduleGraphValidateBeforeCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = scheduleGraphCall(id, progressListener, progressRequestListener);
        return call;
    ...
    public Object scheduleGraph(String id) throws ApiException {
        ApiResponse<Object> resp = scheduleGraphWithHttpInfo(id);
        return resp.getData();
    }
    ...
    public ApiResponse<Object> scheduleGraphWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = scheduleGraphValidateBeforeCall(id, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call scheduleGraphAsync(String id, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = scheduleGraphValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
