...
public class NodeApi {
    ...
    public com.squareup.okhttp.Call getProcessGroupCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/processGroup/{id}"
            .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ProcessGroup getProcessGroup(String id) throws ApiException {
        ApiResponse<ProcessGroup> resp = getProcessGroupWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * Retrieves a process group, which groups multiple processes that were create during one request
     * @param id Unique identifier of the resource (required)
     * @return ApiResponse&lt;ProcessGroup&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ProcessGroup> getProcessGroupWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getProcessGroupValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<ProcessGroup>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProcessGroupAsync(String id, final ApiCallback<ProcessGroup> callback) throws ApiException {
